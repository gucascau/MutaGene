...
#### show the low number of silent mutations
...
write.table(as.matrix(Figure3DCNVdata),file="Fig3DPartSNVC1_datasouce.xls",row.names = TRUE, sep="\t")
...
Mutationload_gene<-read.table("CNVInc_IndelloadExam2.txt",header = T,sep = "\t", na.strings = NA, fill = T)
...
setwd("/Users/xinwang/Documents/Project/Proposal/Figure3/Overlapping_Mutators_20200623/OverlappingMutator_forfigures/Example_intergrated/Indelload_DecMut")
  ...
  Mutationload_gene<-read.table("CNVdec_Indelloadexam2.txt",header = T,sep = "\t", na.strings = NA, fill = T)
...
setwd("/Users/xinwang/Documents/Project/Proposal/Figure3/Overlapping_Mutators_20200623/OverlappingMutator_forfigures/Example_intergrated/CNVload_DecMut/")
  ...
  Mutationload_gene<-read.table("CNVload_decMutExam2.txt",header = T,sep = "\t", na.strings = NA, fill = T)
...
Mutationload_gene<-read.table("CNVload_increaseMut2.txt",header = T,sep = "\t", na.strings = NA, fill = T)
